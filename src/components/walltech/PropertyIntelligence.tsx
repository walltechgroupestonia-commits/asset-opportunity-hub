...
import { DocumentIntelligenceDemo } from "@/components/walltech/DocumentIntelligenceDemo";
        ...
        <div className="container mx-auto px-4">
          <div className="mb-10 max-w-4xl">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-muted-foreground md:text-base">
              Il modulo Property Intelligence raccoglie, qualifica e organizza
              le informazioni necessarie per valutare un’operazione prima di
              aprire il dossier e avviare la due diligence.
            </p>
          </div>
